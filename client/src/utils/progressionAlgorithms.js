const computeProgressionRule = (liftType, experienceLevel) => {
...
const applyProgressionRule = (lift, sessionIndex, userLiftData) => {
...
const adjustProgressionRule = () => {
  return null;
};

export default { computeProgressionRule, applyProgressionRule };
