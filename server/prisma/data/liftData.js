const lifts = [
  ...
  },
  {
    ...
    how_to: [
      "Lie on an incline bench with a barbell above your chest.",
      "Grip the bar slightly wider than shoulder-width.",
      "Lower the bar to your upper chest, keeping elbows at a 45-degree angle.",
  ...
  },
  {
    ...
    how_to: [
      "Sit on an incline press machine with handles at chest level.",
  ...
  },
  {
    ...
    how_to: [
      "Lie on a decline bench with a barbell above your chest.",
      "Grip the bar slightly wider than shoulder-width.",
  ...
  },
  {
    ...
    how_to: [
      "Lie on a decline bench with a dumbbell in each hand at chest level.",
  ...
  },
  {
    ...
    how_to: [
      "Sit on a decline press machine with handles at chest level.",
      "Push the handles forward until arms are extended.",
      "Return to the starting position with control.",
    ],
    primary_muscle_groups: ["Pectorals"],
  ...
  },
  {
    ...
    how_to: [
      "Sit or stand with a barbell at shoulder level, palms facing forward.",
  ...
  },
  {
    name: "Machine Dips",
    how_to: [
      "Sit on a dip machine with handles at chest level.",
      "Push the handles down until arms are extended.",
      "Return to the starting position with control.",
    ],
    primary_muscle_groups: ["Triceps"],
    secondary_muscle_groups: ["Pectorals", "Deltoids"],
  ...
  },
  {
    ...
    how_to: [
      "Stand with dumbbells at your sides, palms facing your body.",
      "Lift the dumbbells forward to shoulder level, keeping arms straight.",
      "Lower the dumbbells back down slowly.",
    ],
    primary_muscle_groups: ["Deltoids"],
    secondary_muscle_groups: ["Pectorals"],
    lift_type: "Supplementary",
    equipment: ["Dumbbells"],
    created_at: new Date(),
  },
  {
    name: "Machine Fly",
    how_to: [
      "Sit on a pec fly machine with arms on the pads.",
  ...
  },
  {
    ...
    primary_muscle_groups: ["Pectorals", "Latissimus Dorsi"],
    secondary_muscle_groups: ["Triceps"],
    lift_type: "Supplementary",
  ...
  },
  {
    name: "Cable Pullup",
    how_to: [
      "Sit at a cable machine with a wide bar attached to a high pulley.",
  ...
  },
  {
    name: "Rear Delt Fly",
    how_to: [
      "Bend forward at the hips with dumbbells in each hand.",
      "Lift the dumbbells out to the sides, squeezing your rear delts.",
  ...
  },
  {
    name: "Lat Pushdown",
    how_to: [
      "Stand at a cable machine with a straight bar attached to a high pulley.",
      "Push the bar down, engaging your lats, keeping arms straight.",
      "Return to the starting position with control.",
    ],
    primary_muscle_groups: ["Latissimus Dorsi"],
    secondary_muscle_groups: ["Triceps"],
  ...
  },
  {
    ...
    how_to: [
      "Lie face down on a back extension bench with feet secured.",
      "Lift your torso until your body forms a straight line.",
      "Lower back down with control.",
    ],
    primary_muscle_groups: ["Lower Back"],
    secondary_muscle_groups: ["Glutes", "Hamstrings"],
    lift_type: "Supplementary",
  ...
  },
  {
    ...
    how_to: [
      ...
      "Bend at the hips, keeping your back straight, until your torso is near parallel.",
      "Return to the standing position.",
    ],
    primary_muscle_groups: ["Hamstrings", "Lower Back"],
  ...
  },
  {
    name: "Barbell Lunge",
    how_to: [
      "Place a barbell across your upper back, feet together.",
  ...
  },
  {
    name: "Dumbbell Lunge",
    how_to: [
      "Hold a dumbbell in each hand, feet together.",
      "Step forward with one leg, lowering until both knees are at 90 degrees.",
      "Push back to the starting position.",
    ],
    primary_muscle_groups: ["Quadriceps", "Glutes"],
  ...
  },
  {
    name: "Hack Squat",
    how_to: [
      "Stand on a hack squat machine with shoulders under the pads.",
  ...
  },
  {
    name: "Belt Squat",
    how_to: [
      "Stand on a belt squat machine with the belt around your hips.",
  ...
  },
  {
    ...
    how_to: [
      "Position yourself on a glute-ham raise bench with feet secured.",
      "Lower your torso while keeping your back straight.",
      "Raise back up by contracting your hamstrings and glutes.",
    ],
    primary_muscle_groups: ["Hamstrings", "Glutes"],
    secondary_muscle_groups: ["Lower Back"],
    lift_type: "Supplementary",
  ...
  },
  {
    ...
    how_to: [
      ...
      "Swing the kettlebell back between your legs, then thrust hips forward.",
      "Focus on glute contraction at the top of the swing.",
    ],
    primary_muscle_groups: ["Glutes"],
    secondary_muscle_groups: ["Hamstrings", "Core"],
    lift_type: "Supplementary",
  ...
  },
  {
    ...
    how_to: [
      ...
      "Bend at the hips and knees, keeping your back straight.",
      "Pull the dumbbell toward your hip, squeezing your lats.",
  ...
  },
  {
    name: "Cable Row",
    how_to: [
      "Sit at a cable row machine with feet braced and knees slightly bent.",
      "Grip the handle and pull it toward your torso, squeezing your shoulder blades.",
      "Return to the starting position with control.",
    ],
    primary_muscle_groups: ["Latissimus Dorsi"],
    secondary_muscle_groups: ["Biceps", "Rear Deltoids"],
  ...
  },
  {
    ...
    primary_muscle_groups: ["Hamstrings", "Glutes", "Lower Back"],
    secondary_muscle_groups: ["Quadriceps", "Trapezius", "Forearms"],
    lift_type: "Main",
    equipment: ["Barbell"],
    created_at: new Date(),
  },
