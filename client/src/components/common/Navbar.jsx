        ...
        >
          ...
          <div className="flex flex-row md:flex-col flex-1 md:flex-none justify-around md:justify-start md:items-center md:mt-auto md:mb-4">
            ...
            >
              ...
              >
                <UserIcon
                  className={`${screenSize.isMobile ? "h-5 w-5" : "h-6 w-6"}`}
                />
              </button>
              {/* Desktop Hover Label */}
              <span
              ...
              {isProfileOpen && (
                <div
                  className={`absolute md:bottom-auto md:top-[-45px] bottom-full mb-2 md:ml-2 md:mb-0 shadow-lg rounded-lg py-2 z-50 bg-[var(--surface)] ${
                    screenSize.isMobile
                      ? "left-[-40%] transform -translate-x-1/2 w-32"
                      : "left-[60px] w-40"
                  }`}
                >
                  <button
